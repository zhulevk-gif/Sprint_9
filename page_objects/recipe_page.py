...
class RecipePage(BasePage):
    ...
    def is_recipe_card_visible(self, recipe_name: str) -> bool:
        return self._is_visible(self._format_locator(RecipeLocators.RECIPE_CARD_BY_NAME, name=recipe_name))

    def is_recipe_title_visible(self, recipe_name: str) -> bool:
        return self._is_visible(self._format_locator(RecipeLocators.TITLE_BY_NAME, name=recipe_name))
    ...
    def _add_ingredient(self, search_text: str, ingredient: str, amount: str):
        ...
        self._is_visible(self._format_locator(RecipeLocators.ADDED_INGREDIENT, ingredient=ingredient, amount=amount))
